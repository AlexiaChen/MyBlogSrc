...
***
 ...
 - **个人技术博客**：
    ...
    1. https://alexiachen.github.io/blog/ （对技术和行业，人生的思考，偏总结）
...
## 云南犀鸟科技有限公司 (2016.11 至 今)

- **行业**:计算机软件
- **职位**：高级软件研发工程师
- **部门**：研发部
- **岗位职责** : 负责平台及基础架构研发，技术架构选型

### 桌面终端安全管控项目
**项目描述**: 桌面终端安全管控软件（TRMS），是主要为云南省各地州市县南方电网供电局研发的企业内网侧重安全的管控软件。

- 编写整个软件的GUI客户端的插件框架，采用XML描述的方式配置插件的加载和展示
- 客户端的设备系统采集插件，把系统的CPU使用率,进程，内存，共享目录，应用窗口标题，网络上下行速度等软指标和CPU型号，主板型号，内存，硬盘容量等硬指标通过消息中间件发送到Server端
- 客户端版本的更新机制，采用守护进程的方式间隔检测版本，并升级客户端的插件
- 客户管理终端的报表展示，监控各个终端软件采集的基本信息
- 客户管理终端的远程协助功能
