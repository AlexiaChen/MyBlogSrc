...
我写了一个python脚本来分析了一本英文书，把这本书的英文句子作为一个训练集，用[马尔科夫链](https://en.wikipedia.org/wiki/Markov_chain)来做处理产生短文，这样也可以算作是一个自动补全的程序了。比如，一些聊天工具和输入法可能就有这样的功能，基于你以前历史的语句输入来判断你当前输入后面可能会输入的单词或语句作提示或者补全。

网络社区也有一些爱好者用[马尔科夫链来生成鸡汤文](https://blog.csdn.net/renhaofan/article/details/82191387)
